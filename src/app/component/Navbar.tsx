...
const Navbar = () => {
    ...
    return (
        <nav className="py-2 h-14 flex items-center justify-between px-6 md:px-16 lg:px-32 py-3 border-b border-gray-300 text-white-700 sticky top-0 z-50 bg-white">
            <Image
